 ...
 */
class PressMates_Most_Popular_Posts_Widget extends WP_Widget {
    ...
    public function __construct() {
        /* Widget settings. */
        $widget_ops = array(
            'classname' => 'pressmates_most_popular_posts_widget',
            'description' => __( 'Shows most popular posts with thumbnails', 'pressmates-core' )
        );

        /* Widget control settings. */
        $control_ops = array(
            'id_base' => 'pressmates_most_popular_posts_widget'
        );

        /* Create the widget. */
        parent::__construct(
            'pressmates_most_popular_posts_widget',
            __( 'PressMates - Most Popular Posts Widget', 'pressmates-core' ),
            $widget_ops,
            $control_ops
        );
    ...
    public function widget( $args, $instance ) {
        ...
        $posts_exclude      = isset( $instance['posts_exclude'] )       ? $instance['posts_exclude']                            : '';
        $categories_exclude = isset( $instance['categories_exclude'] )  ? $instance['categories_exclude']                       : '';
        $range              = isset( $instance['range'] )               ? $instance['range']                                    : '';
        $post_types         = isset( $instance['post_types'] )          ? $instance['post_types']                               : 'post,page';
