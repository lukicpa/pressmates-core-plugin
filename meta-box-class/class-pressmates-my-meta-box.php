<?php
if ( ! class_exists( 'PressMates_Meta_Box') ) :

  /**
   * This class is fork of https://github.com/bainternet/My-Meta-Box
   *
   * PressMates custom meta boxes
   *
   * @link              http://www.pressmates.net
   * @since             1.0.0
   * @package           Pressmates_Core
   * @subpackage Pressmates_Core/meta-box-class
   *
   */
  class PressMates_Meta_Box {
